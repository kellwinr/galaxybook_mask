...
#edited  by manas chachra  with advanced  and  practical functionality
...
### 2 versions
- Non startup version that launches samsung   notes, can be used as  a makeshift shortcut
- This version stores the previous  registery key that it changes  and then reverts the key back  once the  app has  been launched
